...
export function CommandPalette() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-start justify-center pt-[15vh]" onClick={() => setOpen(false)}>
      ...
      <div
        className="relative z-10 w-full max-w-xl rounded-xl border border-neutral-300 bg-white shadow-2xl animate-scale-in overflow-hidden"
      ...
      >
        <div className="flex items-center gap-3 px-4 border-b border-neutral-200">
          ...
          <input
            ...
            className="flex-1 h-12 bg-transparent text-neutral-900 placeholder:text-neutral-400 text-sm focus:outline-none"
          />
          <kbd className="hidden sm:flex items-center gap-0.5 rounded border border-neutral-300 bg-neutral-100 px-1.5 py-0.5 text-[10px] font-mono text-neutral-500">
            ESC
          </kbd>
        </div>
        ...
        <div className="max-h-[50vh] overflow-y-auto scrollbar-thin py-2">
          {flatItems.length === 0 ? (
            ...
            Array.from(groups.entries()).map(([category, items]) => (
              <div key={category}>
                <p className="px-4 pt-3 pb-1.5 text-[10px] font-semibold uppercase tracking-widest text-neutral-400">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {item.description && (
                          <span className="ml-2 text-xs text-neutral-400">{item.description}</span>
                        )}
                      </div>
                      {globalIndex === selectedIndex && (
        ...
        <div className="flex items-center gap-4 px-4 py-2.5 border-t border-neutral-200 text-[10px] text-neutral-400">
