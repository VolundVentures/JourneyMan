...
export function EmployeeCard({ employee, currentTask }: EmployeeCardProps) {
  ...
  return (
    <Link href={`/dashboard/employees/${employee.id}`} className="block group">
      <div className="rounded-xl border border-neutral-800 bg-neutral-900 overflow-hidden transition-colors hover:bg-neutral-800/80 hover:border-neutral-700">
        <div className="p-5 space-y-4">
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-neutral-400 truncate">{employee.roleTitle}</p>
          ...
          {currentTask && (
            <div className="text-xs text-neutral-500">
              <span className="text-neutral-600">Working on: </span>
              <span className="italic text-neutral-400">{currentTask.title}</span>
            </div>
          )}
