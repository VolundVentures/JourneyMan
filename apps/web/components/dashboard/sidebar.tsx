              ...
              <div key={section.label}>
                ...
                >
                  <p className={cn(
                    ...
                    hasActive ? 'text-neutral-400' : 'text-neutral-600'
                  )}>
                    {section.label}
                  </p>
                  <ChevronDown className={cn(
                    'w-3 h-3 text-neutral-700 transition-transform group-hover:text-neutral-500',
                    ...
                    {section.items.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {item.badge && (
                            <span className="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded bg-emerald-950/50 text-emerald-400 animate-pulse-dot">
                              {item.badge}
                            </span>
                          )}
                        </Link>
