...
import type { Employee, Task, EmployeeStatus } from '@journeyman/shared';
...
export function EmployeesView({ employees, tasks }: EmployeesViewProps) {
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {statuses.map((status) => (
            ...
            >
              ...
              {status === 'all' && (
                <span className="ml-1 text-neutral-500">({employees.length})</span>
              )}
            </button>
          ))}
        </div>
