        ...
        <CardContent>
          <div className="flex items-center justify-center gap-8 py-6">
            <div className="text-center">
              <p className="text-3xl font-bold text-neutral-200">{totalTasks.toLocaleString()}</p>
              <p className="text-xs text-neutral-500">tasks completed</p>
            </div>
            <ArrowRight className="w-5 h-5 text-neutral-600" />
            <div className="text-center">
              <p className="text-3xl font-bold text-neutral-200">{humanHours}h</p>
              <p className="text-xs text-neutral-500">human equivalent</p>
            </div>
            <ArrowRight className="w-5 h-5 text-neutral-600" />
            <div className="text-center">
              <p className="text-3xl font-bold text-neutral-200">${humanCost.toLocaleString()}</p>
              <p className="text-xs text-neutral-500">@ $50/hr</p>
            </div>
            <span className="text-neutral-600 text-xl">vs</span>
            <div className="text-center">
              <p className="text-3xl font-bold text-emerald-400">${totalAICost.toLocaleString()}</p>
              <p className="text-xs text-neutral-500">AI cost</p>
            </div>
            <span className="text-neutral-600 text-xl">=</span>
            <div className="text-center">
              <p className="text-4xl font-bold text-emerald-400">{roi}x</p>
          ...
          <div className="space-y-4">
            {costData.map((data) => (
              <div key={data.employeeId} className="flex items-center gap-4">
                ...
                <span className="text-sm text-neutral-200 w-20">{data.name}</span>
