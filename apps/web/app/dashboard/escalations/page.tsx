      ...
      <div className="p-5 space-y-4">
        <div className="flex items-start gap-3">
          <div className="rounded-lg p-2 bg-neutral-800">
            <UrgencyIcon className="w-5 h-5 text-neutral-300" />
          </div>
          <div className="flex-1 min-w-0">
            ...
            <h3 className="mt-1.5 font-semibold text-neutral-100">{escalation.reason}</h3>
          </div>
          <div className="flex items-center gap-2 shrink-0">
            <Avatar name={escalation.employeeName || 'AI'} emoji={emoji} size="sm" />
            <div className="text-right">
              <p className="text-sm font-medium text-neutral-200">{escalation.employeeName}</p>
        ...
        {expanded && (
          <div className="rounded-lg bg-neutral-950 border border-neutral-800 p-4 text-sm text-neutral-400 animate-fade-in">
        ...
        {escalation.recommendation && (
          <div className="rounded-lg border border-neutral-700 bg-neutral-800/50 p-4">
            <div className="flex items-start gap-2">
              ...
              <div>
                <p className="text-xs text-neutral-400 uppercase tracking-wider font-medium mb-1">AI Recommendation</p>
                <p className="text-sm text-neutral-300 leading-relaxed">{escalation.recommendation}</p>
              </div>
            </div>
          </div>
        )}
...
export default function EscalationsPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-bold text-neutral-50">Escalation Center</h1>
      ...
      {open.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <h3 className="text-xl font-semibold text-neutral-200 mb-1">No Open Escalations</h3>
